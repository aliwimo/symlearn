...
class FP:
    ...
    def plot(self, X_test, X_train, y, y_predict, t_train, t_test):
        ...
        line = [None, None, None]
        line[0], = ax.plot(t, y, linestyle='-', color='black', linewidth=0.5, zorder=1)    
        line[1], = ax.plot(t_train, y_model, linestyle='-', color='blue', linewidth=0.5, zorder=2)
        line[2], = ax.plot(t_test, y_predict, linestyle='-', color='red', linewidth=0.5, zorder=3)
